...
public class JavaScript {
  ...
  /**
   * Attempts to evaluates a JSON expression and returns whether it is valid.
   * 
   ...
   * 
   * @param booleanExpr true if parsing is successful, else false
   * @throws ScriptException if internal error occurs
   */
  public void isValidBooleanExpression(String booleanExpr) throws ScriptException {
