...
public class PostgreSQL extends DBPlatform {
     ...
     */
    @Override
    public void createSequence(DataSource dataSource, String sequence,
        int start, int increment) throws SQLException {
    ...
    public int getNextId(DataSource dataSource, String schema, String table)
        ...
        sql.append("')");
        long id = (Long) SqlUtils.executeScalar(dataSource,
    ...
    public boolean checkTableExists(DataSource dataSource, String schema,
        ...
        long count = (Long) SqlUtils.executeScalar(dataSource,
